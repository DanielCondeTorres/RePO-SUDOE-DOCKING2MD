...
gmx mdrun -v -deffnm "$OUTPUT_SAVE"min_fep1 -ntmpi 1 || exit 1
...
gmx mdrun -v -deffnm "$OUTPUT_SAVE"eq_nvt_fep -ntmpi 1 || exit 1
...
gmx mdrun -v -deffnm "$OUTPUT_SAVE"eq_npt_fep_1 -ntmpi 1 || exit 1
...
gmx mdrun -v -deffnm "$OUTPUT_SAVE"prod -ntmpi 1 || exit 1
